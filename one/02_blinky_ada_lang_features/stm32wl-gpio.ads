...
package STM32WL.GPIO is
   ...
   GPIOA : GPIO_Peripheral with
     Volatile, Import, Address => System'To_Address (16#4800_0000#);

   GPIOB : GPIO_Peripheral with
     Volatile, Import, Address => System'To_Address (16#4800_0400#);

   GPIOC : GPIO_Peripheral with
     Volatile, Import, Address => System'To_Address (16#4800_0800#);
