...
procedure Main is
   ...
   GPIOB_MODER : Interfaces.Unsigned_32 with
     Volatile, Address => System'To_Address (16#4800_0400#);

   GPIOB_BSRR : Interfaces.Unsigned_32 with
     Volatile, Address => System'To_Address (16#4800_0418#);
